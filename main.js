...
function initLetterTyping() {
    ...
    const letterParts = [
        ...
        ['letter-p1', 'Hoy celebramos algo que va mucho más allá de un título. Celebramos tu valía.'],
        ['letter-p2', 'Han sido cuatro años de dedicación, esfuerzo y crecimiento los que te han traído hasta aquí. No ha sido un camino fácil, y precisamente por eso tiene tanto valor. Has demostrado una fortaleza y una determinación que te acompañarán siempre.'],
        ['letter-p3', 'El mundo necesita personas como tú: curiosas, perseverantes y con la capacidad de convertir las ideas en realidad. Estoy súper orgulloso de ti, de la mujer que eres y de todo lo que estás consiguiendo. Puedo decir, sin dudarlo, que soy una de las personas más afortunadas del mundo por estar con alguien tan impresionante y maravillosa como tú.'],
